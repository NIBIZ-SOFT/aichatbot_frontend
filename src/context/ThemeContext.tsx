...
export const DEFAULT_THEME_PRESETS: ThemeConfig[] = [
  {
    ...
    widget_avatar_url: "",
    footer_text: "© 2026 Jobab Chat Platform • Enterprise Autonomous AI Customer Support Platform",
  ...
  },
  {
    ...
    platform_name: "Jobab Emerald Live",
  ...
  },
  {
    ...
    badge: "Raycast Style",
    platform_name: "Jobab Raycast Support",
  ...
  },
  {
    ...
    platform_name: "Jobab Cosmic Cloud",
  ...
  },
  {
    ...
    favicon_url: "",
    widget_avatar_url: "",
    footer_text: "© 2026 Apex Fintech AI • Enterprise Autonomous AI Platform",
  ...
  },
  {
    ...
    favicon_url: "",
    widget_avatar_url: "",
    footer_text: "© 2026 Zinc AI Platform • Enterprise Autonomous AI Platform",
      ...
      try {
        ...
        if (res && res.theme) {
          const remoteTheme: ThemeConfig = {
            ...
            footer_text: res.theme.footer_text || "© 2026 Jobab Chat Platform • Enterprise Autonomous AI Customer Support Platform",
